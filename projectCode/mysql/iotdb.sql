...
insert into devices(name, state, category_id, description, create_time, update_time) values ('光纤',0, 2, 'test4',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('光线',0, 2, 'test4',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('红光',0, 2, 'test4',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('颜色控制',0, 2, 'test4',now(),now());

insert into devices(name, state, category_id, description, create_time, update_time) values ('冰冻',0, 3, 'temperature1',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('常温',0, 3, 'temperature2',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('滚烫',0, 3, 'temperature3',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('绝对零度',0, 3, 'afeeaf',now(),now());
insert into devices(name, state, category_id, description, create_time, update_time) values ('零度',0, 3, 'afeweeeeg',now(),now());

insert into devices(name, state, category_id, description, create_time, update_time) values ('声音',0, 4, 'voice',now(),now());
